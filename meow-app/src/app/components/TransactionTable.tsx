                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center">
                  {transaction.account_from_details ? (
                    <button
                      onClick={() =>
                        handleAccountClick(
                          transaction.account_from_details!.id,
                          transaction.account_from_details!.customer_id,
                        )
                      }
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center">
                  {transaction.account_to_details ? (
                    <button
                      onClick={() =>
                        handleAccountClick(
                          transaction.account_to_details!.id,
                          transaction.account_to_details!.customer_id,
                        )
                      }
                      className="text-blue-600 hover:text-blue-800 hover:underline font-medium transition-colors cursor-pointer"
                    >
