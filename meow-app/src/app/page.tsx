    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Customers Card */}
          <div
            className="bg-white rounded-xl shadow-lg p-8 border border-gray-200 hover:shadow-xl transition-all duration-200 cursor-pointer text-center"
          ...
          >
            ...
            <p className="text-gray-700 mb-6">
              View and manage customer information, create new accounts, and monitor account balances across all
          ...
          >
            ...
            <p className="text-gray-700 mb-6">
              Facilitate secure money transfers between any accounts in the system. Select customers and accounts to
